! function() {
	...
	t.prototype = {
		init: function(t) {
			this.opts = this.extend(e, t), this.render()
		},
		render: function() {
		...
		start: function(t) {
			...
			t.addEventListener("touchstart", function(t) {
				e.result || (this.className = "ft-slider-bar", s.className = "ft-slider-bg", e.isDrag = !0, e.strartX = t.touches[0].clientX, t.preventDefault())
			}, !1)
		},
		move: function(t) {
			var e = this,
				...
				r = s.getElementsByClassName("ft-slider-bar")[0];
			t.addEventListener("touchmove", function(t) {
				if(e.isDrag && !e.result) {
					var n = t.touches[0].clientX - e.strartX,
						l = s.offsetWidth -  this.offsetWidth;
			...
			var e = this,
				...
				i = s.getElementsByClassName("ft-slider-bg")[0];
				q = s.getElementsByClassName("ft-slider-bar")[0];
			t.addEventListener("touchend", function(t) {
				if(e.isDrag) {
					var l = e.opts,
						a = l.callback,
						r = t.changedTouches[0].clientX - e.strartX,
						d = s.offsetWidth - q.offsetWidth;
						h = 0;
		...
		extend: function(t, e) {
			...
			for(var i = 0; i < arguments.length; i++)
				for(option in arguments[i]) s[option] = arguments[i][option];
			return s
		},
