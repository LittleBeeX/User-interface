...
(function(e) {
	...
	e.extend(e.validator, {
		...
		messages: {
			...
			maxlength: e.validator.format("请输入不超过 {0} 字符."),
			minlength: e.validator.format("请输入至少 {0} 字符."),
			rangelength: e.validator.format("请输入一个值在 {0} 和 {1} 字符长度内."),
			range: e.validator.format("请输入一个值在 {0} 和 {1}."),
			max: e.validator.format("请输入一个值小于或等于 {0}."),
			min: e.validator.format("请输入一个值大于或等于 {0}.")
		},
		autoCreateRanges: !1,
		prototype: {
			init: function() {
		...
		methods: {
			...
			mobile: function(e, t) {
				return this.optional(t) || /^0{0,1}(13[0-9]|15[0-9])[0-9]{8}$/i.test(e)
			},
			url: function(e, t) {
